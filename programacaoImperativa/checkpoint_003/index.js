...
let aluno003 = new estudantes.AddAluno("Joice", 1, [5, 2, 1]); // ("Joice", 1, [5, 7, 8])
let aluno004 = new estudantes.AddAluno("Laura", 5, [3.5, 4.7, 6]);
let aluno005 = new estudantes.AddAluno("Carlos", 3, [6, 7, 7]); // Parâmetros ao lado esquerdo para testar condição de número de faltas igual ao número de faltas máximas permitidas e nota acima de 10% da nota de aprovação (Passo 5) ("Carlos", 0, [6, 7, 8]);
